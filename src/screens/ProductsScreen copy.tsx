...
//   return {
//     badge:
//       product.category === "Current Transformers" ? "Top Rated" : product.brand === "ALECS" ? "ALECS" : "Industrial",
//     price: "Custom Quote",
//     subtitle: product.specs.slice(0, 2).join(" | "),
//     features:
//       product.customizations.slice(0, 2).map((item) => item.option.split(":")[0].trim()) || [],
//   };
// }
